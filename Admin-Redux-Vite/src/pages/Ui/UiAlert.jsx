...
class UiAlert extends Component {
  constructor(props) {
    ...
    this.t_show = this.t_show.bind(this)
  }
  toggle() {
    this.setState({
  ...
  render() {
    //meta title
    document.title = "Alerts | Skote - Vite React Admin & Dashboard Template";
    return (
      <React.Fragment>
                  ...
                  <CardBody>
                    ...
                    <div className="">
                      <div id="liveAlertPlaceholder">
                        <Alert isOpen={this.state.show} toggle={this.toggle}>
                          Nice, you triggered this alert message!
                        </Alert>
                      </div>
                      <button type="button" className="btn btn-primary" onClick={this.t_show} id="liveAlertBtn">Show live alert</button>
                    </div>
