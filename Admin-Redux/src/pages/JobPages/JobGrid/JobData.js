...
class JobData extends Component {
    ...
    render() {
        return (
            <React.Fragment>
                <Row>
                    {(this.state.jobsGridData || []).map((item, key) => (
                            ...
                            <Card>
                                <CardBody>
                                    ...
                                    <div className="mt-4 hstack gap-2">
                                        ...
                                        <Link to="#applyJobs" onClick={this.t_modal} className="btn btn-soft-primary w-100">Apply Now</Link>
                                    </div>
                                </CardBody>
                            </Card>
                        </Col>
                ...
                >
                    <div className="modal-content">
                        <ModalHeader toggle={this.t_modal} id="applyJobsLabel" className="modal-header">
                            Apply For This Job
                        </ModalHeader>
                        <ModalBody>
                            <Row>
