      ...
      <SimpleBar className="h-100" ref={ref}>
        <div id="sidebar-menu">
          <ul className="metismenu list-unstyled" id="side-menu">
            ...
            <li>
              <Link to="/hr" className="has-arrow ">
                <i className="bx bx-user-circle"></i>                
                <span>{props.t("HR DEPARTMENT")}</span>
              </Link>
              <ul className="sub-menu">
                <li>
                  <Link to="/pages-login">{props.t("TRAINING REQUEST REGISTER")}</Link>
                </li>
                <li>
                  <Link to="/pages-login-2">{props.t("TRAINING PLAN")}</Link>
                </li>
                <li>
                  <Link to="/pages-register">{props.t("TRAINING  SCHEDULE")}</Link>
                </li>
                <li>
                  <Link to="/pages-register-2">{props.t("TRAINING  ATTENDANCE")}</Link>
                </li>
                <li>
                  <Link to="/page-recoverpw">
                    {props.t("SKILL MATRIX")}
                  </Link>
                </li>
                <li>
                  <Link to="/page-recoverpw-2">
                    {props.t("COMPETENCY MATRIX")}
                  </Link>
                </li>
                <li>
                  <Link to="/auth-lock-screen">{props.t("TRAINING  EVALUATION")}</Link>
                </li>
                <li>
                  <Link to="/auth-lock-screen-2">
                    {props.t("APPOINTMENT LETTER")}
                  </Link>
                </li>
