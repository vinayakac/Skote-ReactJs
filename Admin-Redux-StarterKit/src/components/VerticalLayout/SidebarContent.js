            ...
            <ul className="metismenu list-unstyled" id="side-menu">
              ...
              <li>
                ...
                <ul className="sub-menu">
                  ...
                  <li><Link to="#">{this.props.t("Apply Job")}</Link></li>
                  <li><Link to="#">{this.props.t("Job Details")}</Link></li>
                  <li><Link to="#">{this.props.t("Jobs Categories")}</Link></li>
                  <li>
                    <Link to="/#" className="has-arrow">{this.props.t("Candidate")}</Link>
                    <ul className="sub-menu" aria-expanded="true">
                      <li><Link to="#">{this.props.t("List")}</Link></li>
              ...
              <li>
                ...
                <ul className="sub-menu" aria-expanded="false">
                  ...
                  <li>
                    <Link to="#">
                      {this.props.t("Timeline")}</Link>
                  </li>
                  <li>
                    <Link to="#">
                      {this.props.t("FAQs")}</Link>
                  </li>
                  <li>
                    <Link to="#">
                      {this.props.t("Pricing")}</Link>
                  </li>
                  <li>
                    <Link to="#">
                      {this.props.t("Error 404")}</Link>
                  </li>
                  <li>
                    <Link to="#">
                      {this.props.t("Error 500")}</Link>
                  </li>
                </ul>
              </li>
              ...
              <li>
                ...
                <ul className="sub-menu" aria-expanded="false">
                  <li>
                    <Link to="#">
                      {this.props.t("Alerts")}</Link>
                  </li>
                  <li>
                    <Link to="#">
                      {this.props.t("Buttons")}</Link>
                  </li>
                  <li>
                    <Link to="#">
                      {this.props.t("Cards")}</Link>
                  </li>
                  <li>
                    <Link to="#">
                      {this.props.t("Carousel")}</Link>
                  </li>
                  <li>
                    <Link to="#">
                      {this.props.t("Dropdowns")}</Link>
                  </li>
                  <li>
                    <Link to="#">
                      {this.props.t("Grid")}</Link>
                  </li>
                  <li>
                    <Link to="#">
                      {this.props.t("Images")}</Link>
                  </li>
                  <li>
                    <Link to="#">
                      {this.props.t("Lightbox")}</Link>
                  </li>
                  <li>
                    <Link to="#">
                      {this.props.t("Modals")}</Link>
                  </li>
                  <li>
                    <Link to="#">
                      {this.props.t("OffCanvas")}</Link>
                  </li>
                  <li>
                    <Link to="#">
                  ...
                  <li>
                    <Link to="#">
                      {this.props.t("Placeholders")}</Link>
                  </li>
                  <li>
                    <Link to="#">
                  ...
                  <li>
                    <Link to="#">
                      {this.props.t("Toasts")}</Link>
                  </li>
                  <li>
                    <Link to="#">
                      {this.props.t("Video")}</Link>
                  </li>
                  <li>
                    <Link to="#">
                      {this.props.t("General")}</Link>
                  </li>
                  <li>
                    <Link to="#">
                      {this.props.t("Colors")}</Link>
                  </li>
                  <li>
                    <Link to="#">
                      {this.props.t("Rating")}</Link>
                  </li>
                  <li>
                    <Link to="#">
              ...
              <li>
                ...
                <ul className="sub-menu" aria-expanded="false">
                  ...
                  <li>
                    <Link to="#">{this.props.t("Knob Charts")}</Link>
                  </li>
                  <li>
                    <Link to="#">
